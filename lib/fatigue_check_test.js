...
function testFatigueFlappingTrue () { 
  ...
  if (result) { 
    console.log("testFatigueFlappingTrue PASSED, returned true"); 
  } else { 
    console.log("testFatigueFlappingTrue FAILED, returned false"); 
  }
}

function testFatigueFlappingFalse () { 
  // This event is only a stub of a real event 
  var event = {
  "check": {
    "annotations": {
  ...
  if (result) { 
    console.log("testFatigueFlappingFalse FAILED, returned true"); 
  } else { 
    console.log("testFatigueFlappingFalse PASSED, returned false"); 
  }
}
